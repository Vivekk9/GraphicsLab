...
public:
	void init() {
		...
		///TODO1: Pack vertex colors in this array. The order should be v1 coords (given), v1 color, v2 coords(given), v2 color,... (Weightage-10%)
		...
		///TODO2: Create Vertex Attribute to store Vertex colors (Weightage-10%)
		// Get the location id for vcolor-similar to Line 36    
