...
public:
	void init() {
		...
		///--- Texture coordinates
		{
			...
			///TODO1: Allocate memory for storing texture coordinates (Weightage-10%)
			

			///TODO2: Create Vertex Attribute pointer to specify vertex texture coordinates (Weightage-10%) 
			
		}

		///--- Load texture
		this->loadTextures("Quad/flower1.png");
