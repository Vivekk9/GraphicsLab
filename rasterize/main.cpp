...
void rasterize(Line l, Image &image) {
    ...
    /// Task 1: Implement Bresenham's mipoint algorithm(40%). 
	//TODO: Calculate error delta (5%)
    //float deltax = ?
    //float deltay = ?
...
int main(int, char**){
    ...
    //Task 3: Draw a grid with cells of size 20 x 20 pixels and render a triangle on the grid(20%).
