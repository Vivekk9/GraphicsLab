...
int main(int, char**) {
	...
	//include the h_samples and v_samples of your supersampling grid, e.g., the grid may be 2 x 2 or 4 x 4
	int h_samples = 0;
	int v_samples = 0;
	//end
	...
	for (int row = 0; row < image.rows; ++row) {
		for (int col = 0; col < image.cols; ++col) {
			...
			//Compute the average of pixelColour			
